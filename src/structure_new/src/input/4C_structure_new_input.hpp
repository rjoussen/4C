...
#ifndef FOUR_C_STRUCTURE_NEW_INPUT_HPP
#define FOUR_C_STRUCTURE_NEW_INPUT_HPP
...
namespace Solid
{
  ...
  {
    constdis,        ///< constant displacements, consistent velocities and accelerations
    constvel,        ///< constant velocity, extrapolated displacements, consistent accelerations
    constacc,        ///< constant acceleration, extrapolated displacements and velocities
    constdisvelacc,  ///< constant displacements,
                     ///< velocities and accelerations
    tangdis,         ///< linearised solution obeying DBC displacements via tangent
    ...
    tangdis_constfext,   ///< tangential displacement predictor with respect
                         ///< to a constant Neumann force during the predictor
                         ///< step
    constdispres,        ///< constant displacements and pressure
    constdisvelaccpres,  ///< constant displacements,
                         ///< velocities and accelerations
                         ///< and pressures
    python_wrapper       ///< external predictor, where the actual prediction will be
