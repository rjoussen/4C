  ...
  namespace TimeInt
  {
    ...
    class Implicit : public ImplicitBase
    {
     ...
     private:
      ...
      //! Update time-step control history and choose the time-step size for the next step.
      void update_time_step_control_after_successful_step();

      //! Set the time-step size for the next step and refresh constant contributions.
      void set_time_step_size(double new_dt);
