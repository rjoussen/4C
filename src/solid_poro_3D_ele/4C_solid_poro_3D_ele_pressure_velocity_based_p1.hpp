...
#ifndef FOUR_C_SOLID_PORO_3D_ELE_PRESSURE_VELOCITY_BASED_P1_HPP
#define FOUR_C_SOLID_PORO_3D_ELE_PRESSURE_VELOCITY_BASED_P1_HPP
...
namespace Discret::Elements
{
  ...
  class SolidPoroPressureVelocityBasedP1Type : public Core::Elements::ElementType
  {
   ...
   private:
    static SolidPoroPressureVelocityBasedP1Type instance_;
  ...
  class SolidPoroPressureVelocityBasedP1 : public Core::Elements::Element
  {
    ...
    */
    SolidPoroPressureVelocityBasedP1(int id, int owner);
   ...
   private:
    ...
    std::optional<std::vector<double>> initial_porosity_{};
